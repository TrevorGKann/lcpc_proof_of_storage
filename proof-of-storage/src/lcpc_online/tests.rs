...
async fn encode_then_decode_file() {
        ...
        .into_iter()
    {
        ...
        let encoded_tree = EncodedFileWriter::<WriteableFt63, Blake3, LigeroEncoding<WriteableFt63>>::convert_unencoded_file(
            &mut tokio::fs::File::open(&test_file_path).await.expect("couldn't open test file"),
            &file_path_encoded,
            None,
            pre_encoded_len,
            encoded_len,
...
async fn edit_file_is_correct() {
    ...
    let file_path_merkle = PathBuf::from("test_files/edit_test_merkle.txt");
        ...
        .into_iter()
    {
        ...
        let mut file_handler = FileHandler::<Blake3, WriteableFt63, LigeroEncoding<WriteableFt63>>::create_from_unencoded_file(
            &test_ulid,
            Some(&test_file_path),
            pre_encoded_len,
            encoded_len,
...
fn test_that_rate_aligns() {
        ...
        .into_iter()
    {
        ...
        for _ in 0..100 {
            ...
            assert_eq!(
                random_file_len
                    .next_multiple_of(WriteableFt63::DATA_BYTE_CAPACITY as usize * pre_encoded_len),
                decoded_file_size,
